...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Class/</span> Assign Class</h4>
    ...
    <div class="card">
        <div class="row">
            <div class="col-md-5">
                <h5 class="card-header">Class Data</h5>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-3"><span>: {{ $item->classCode }}</span></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-3"><span>: {{ $item->year }}</span></div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-3"><span>: {{ $item->course }}</span></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
                ...
                <tbody>
                    ...
                    @foreach ($result as $item)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('DeleteAssignClass', $item->assignClassId) }}" method="post">@csrf
    ...
    <div class="modal fade" id="facultymodal" tabindex="-1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('AssignClass') }}" method="post">@csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="hidden" id="classId" name="classId" value="{{ $item->classId }}">
                                <h5>Class Name : <span id="clsName">{{ $item->classCode }}</span></h5>
                            </div>
                            <div class="col-md-6">
                                <h5>Year : <span id="clsYear">{{ $item->year }}</span></h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h5>Course : <span id="clsCourse">{{ $item->course }}</span></h5>
                            </div>
                            <div class="col-md-6">
