...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../AdminCss/assets/css/custom-css.css') }}" />
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/faculty-dashboard" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item @yield('dashboard')" id="dashboard">
                        <a href="/faculty-dashboard" class="menu-link">
                    ...
                    <li class="menu-item @yield('student')" style="">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('faculty-student.create') }}" class="menu-link">
                                    <div data-i18n="Basic">Add Student</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('faculty-student-display') }}" class="menu-link">
                                    <div data-i18n="Basic">Display Student</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item @yield('class')" id="class">
                        <a href="{{ route('faculty-class.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-book-open"></i>
                            <div data-i18n="Analytics">Assign Class</div>
                        </a>
                    </li>
                    <li class="menu-item @yield('report')" id="report">
                        <a href="/attendance-report" class="menu-link">
                    ...
                    <li class="menu-item @yield('profile')" id="addUser">
                        <a href="{{ route('faculty-profile.index') }}" id="display-complain" class="menu-link">
