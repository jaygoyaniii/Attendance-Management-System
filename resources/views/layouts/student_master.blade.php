        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/student-dashboard" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item @yield('report')" id="report">
                        <a href="/attendance-details" class="menu-link">
                    ...
                    <li class="menu-item @yield('profile')" id="addUser">
                        <a href="{{ route('student-profile.index') }}" id="display-complain" class="menu-link">
