...
<html
  ...
  data-assets-path="{{ asset('../AdminCss/assets/') }}"
...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('../AdminCss/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('../AdminCss/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('../AdminCss/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
